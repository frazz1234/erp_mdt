...
ALTER TABLE `owned_vehicles` ADD COLUMN `code` LONGTEXT NULL DEFAULT NULL AFTER `image`;
ALTER TABLE `owned_vehicles` ADD COLUMN `stolen` LONGTEXT NULL DEFAULT NULL AFTER `code`;
